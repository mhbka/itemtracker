...
use crate::{
    ...
    messages::{
        ...
        }, ImageClassifierSender, ItemScraperSender, StateTrackerSender
    }
};
...
impl Handler {
    ...
    pub async fn analyze_gallery_in_state(&mut self, gallery_id: GalleryId) -> Result<(), SearchScraperError> {
    ...
    async fn analyze_gallery(&mut self, gallery: GallerySearchScrapingState) -> Result<(), SearchScraperError> {
